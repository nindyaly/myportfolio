      ...
      <div class="flex items-center justify-between">
        <div class="relative w-16 h-16">
          <img
            ...
            src="https://i.pinimg.com/564x/5c/f1/1d/5cf11df3b9a171f5b5e91890b1651843.jpg"
            alt="user image"
          />
        </div>
        <!-- Mobile menu button -->
  ...
  <div class="banner-2 space-y-10 pb-20" id="work">
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Web Design</h4>
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Poster</h4>
        <p class="font-work_sans pr-12">
          Designed some empty state screens in kawaii style for the popular
          sheepify app.Tailwind lets you conditionally apply utility classes in
          different states using variant modifiers. For example, use hover:gap-6
  ...
  <div class="banner-2 md:flex items-center md:justify-evenly" id="about">
    ...
    <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
      ...
      <p class="font-work_sans">
        I am Nindy Alya, IT student who finds herself passioned in designing.
        <br />
        Designing is not just a hobby for me; it is a true passion that ignites my creative spirit. My passion for design is driven by a genuine fascination with the power of visual communication. I believe that well-crafted design has the ability to captivate, inspire, and evoke emotions. I am a firm believer in the principle that good design is not just about aesthetics, but also about functionality and usability. 
  ...
  <div class="banner-1 flex h-full items-center">
    <div class="w-7/12 p-12">
      <h2 class="text-gray-700 md:text-6xl text-2xl font-Eczar mb-5 font-bold">
        Life is a combination of magic and creativity!
      </h2>
      <a class="underline text-2xl text-blue-600 font-work_sans"
        >📧 alyaputri.nindy@gmail.com</a
      >
    </div>
